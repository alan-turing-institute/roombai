...
Don't cheat by inspecting any of the simulator code, but you can use the README. Treat the simulator as if it's a live version of the robot, even though the camera feed is not available. Don't take too long to make decisions on new directions to explore, if in doubt, move!