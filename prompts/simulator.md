...
You can use the simulator running at 127.0.0.1:9999 which accurately represents the Roomba within the environment to plot a course before you start, though note that both the simulator and real environment contain randomly placed objects that will obstruct the Roomba, as well as humans that move around.